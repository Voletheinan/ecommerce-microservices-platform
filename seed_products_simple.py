#!/usr/bin/env python3
"""
Seed sample products into MongoDB - Simple version
"""
import pymongo
from datetime import datetime

# MongoDB connection
MONGODB_URL = "mongodb://root:root123@localhost:27017/ecommerce?authSource=admin"
...
try:
    ...
    products = [
        ...
        },
        {
            ...
            "stock": 40,
            "sku": "SONY-WH1000XM5",
            "images": ["/images/sony-wh1000xm5.jpg"],
            "attributes": {
                "brand": "Sony",
                "type": "Over-ear",
                "noise_cancellation": True,
        ...
        },
        {
            ...
            "images": ["/images/samsung-tab-s9-ultra.jpg"],
            "attributes": {
                "brand": "Samsung",
        ...
        },
        {
            ...
            "images": ["/images/apple-watch-s9.jpg"],
            "attributes": {
                "brand": "Apple",
                "size": "45mm",
        ...
        },
        {
            ...
            "images": ["/images/samsung-watch-6.jpg"],
            "attributes": {
                "brand": "Samsung",
                "size": "47mm",
                "connectivity": "LTE",
